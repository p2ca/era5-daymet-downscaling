...
# commit 17efe3e3f4d179fc59e822543697add589426147, physicsnemo/utils/diffusion/stochastic_sampler.py
# 除 patching 的导入指向本仓库同名移植模块外, 逐字节未改。
# 这是 EDM Algorithm 2 的二阶随机采样器, 全域采样时由官方 GridPatching2D 负责切块与加权融合。
